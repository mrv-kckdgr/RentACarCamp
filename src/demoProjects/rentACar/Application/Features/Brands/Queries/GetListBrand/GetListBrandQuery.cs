...
namespace Application.Features.Brands.Queries.GetListBrand
{
    public class GetListBrandQuery : IRequest<BrandListModel>
    {
        ...
        public class GetListBrandQueryHandler : IRequestHandler<GetListBrandQuery, BrandListModel>
        {
            ...
            public GetListBrandQueryHandler(IBrandEntityRepository brandRepository, IMapper mapper)
            {
            ...
            {
                IPaginate<BrandEntity> brands = await _brandRepository.GetListAsync(index: request.PageRequest.Page, size: request.PageRequest.PageSize);
